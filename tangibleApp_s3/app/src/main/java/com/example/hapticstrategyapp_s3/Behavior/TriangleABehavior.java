...
import com.example.hapticstrategyapp_s3.Polygons.TriangleAPolygons;
import com.example.hapticstrategyapp_s3.R;

public class TriangleABehavior extends SlideBehaviorPolygon {

    boolean speak = true;

    public TriangleABehavior(SlideController sc) {
        super(R.drawable.QuadA, sc);
    }
    ...
    public void tapReaction(int x, int y, Bitmap bitmap, SlideActivity sa) {
        ...
        TriangleAPolygons poly = new TriangleAPolygons();
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, TriangleAPolygons poly, SlideActivity sa, String action) {
